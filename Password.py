...
class PasswordGenerator:
    def __init__(self, root):
        ...
        self.username_label = tk.Label(root, text="Enter User Name:",  font=("Arial̥", 14, "bold"), fg="red",bg="light yellow")
        self.username_label.pack(pady=10)

        self.username_entry = tk.Entry(root, font=("Arial", 14))
        self.username_entry.pack(pady=10)

        self.length_label = tk.Label(root, text="Enter Password Length:", font=("Arial", 14, "bold"),fg = "red",bg="light yellow")
        ...
        self.generated_password_label = tk.Label(root, text="Generated Password:", font=("Arial", 10),bg ="yellow")
