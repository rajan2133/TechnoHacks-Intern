...
class ToDoList:
    def __init__(self, root):
        ...
        self.heading_frame = tk.Frame(root, bg="pink")
        self.heading_frame.pack(fill=tk.X)

        font_style = font.Font(size=13)

        self.task_label = tk.Label(self.heading_frame, text="Enter your task:", fg="black", bg="green", font=font_style)
        ...
        self.save_button = tk.Button(root, text="Save Tasks", command=self.save_tasks, fg="black", bg="light green", font=font_style)
        self.save_button.pack(side=tk.LEFT)

        self.load_button = tk.Button(root, text="Open Saved Tasks", command=self.load_tasks, fg="black", bg="orange", font=font_style)
